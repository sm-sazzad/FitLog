...
const Banner = () => {
    return (
        <div className='w-[80%] mx-auto my-10 flex justify-between items-center bg-[#15171d] p-14 rounded-xl'>
            <div className='w-[60%] space-y-4'>
                <span className='text-[#C2F800]'>WORKOUT LIBRARY</span>
                <h1 className='text-[50px] font-bold leading-none'>TRAIN WITH INTENT. LOG EVERY SET.</h1>
            ...
            <div className='w-[40%]'>
                <Image src={bannerImg} alt='FitLog' className=' justify-self-end'></Image>
            </div>
        </div>
    );
};
